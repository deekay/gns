...
3. The name then enters a settlement period of **52,000 blocks**. During that period, bond continuity matters.
4. Once settlement completes, the name becomes fully active.
