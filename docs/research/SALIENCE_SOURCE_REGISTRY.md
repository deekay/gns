...
| `PUB_OPS` | Founder executive investor and public-intellectual prominence sources | `wave_3b` | needed for names like `markzuckerberg`, `patrickcollison`, or `tylercowen` where the key issue is durable full-name operator identity plus uneven hostage-risk |
